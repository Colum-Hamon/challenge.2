...
abstract: "I'm doing my first challenge on Rstudio for computational methods"
keywords: "challenge, Rstudio, good, grades, please"
...
```{r, eval=TRUE, echo=FALSE, size="small", fig.cap="Here's a better title", out.width="75%", fig.align="center"}
library(tidyverse)
library(anesr)
...
[^one_footnote]:Inoticed that footnote !
